...
| ----------------- | ------  | ------ | -------------- | ----------- |
| [BILL 1.0 spec](http://ausdigital.org/specs/ausdigital-bill/1.0/) | 1.0 | ![Raw](http://rfc.unprotocols.org/spec:2/COSS/raw.svg) | [BILL 1.0 API](http://swagger.testpoint.io?url=http://ausdigital.org/specs/ausdigital-bill/1.0/swagger.yaml){:target="_blank"} |  [BILL 1.0 Issues](https://github.com/ausdigital/ausdigital-bill/issues)  |
